...
<body>
    ...
    <div class="container abrigo">
        <div class="card-group">
            <div class="card">
                <img class="cardimg" src="img/abrigo/logo.jpg" class="card-img-top" alt="...">
                <div class="card-body">
            ...
            <div class="card">
                <h4 class="p-2 text-light">Nossa Equipe</h4>
                ...
                <div>
                    <p class="text-center text-light">Localização</p>
                ...
                <div class="card-body">
                    <h5 class="card-title text-center text-light">Horário de Funcionamento</h5>
